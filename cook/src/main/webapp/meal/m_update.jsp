...
<html>
	...
	<body>
		...
		<!--  메인 -->
			<form method = "post" enctype = "multipart/form-data" name = "frm" action="MealUpdate?m_no=${meal.m_no}">
				
				<div>
					<input type="text" name="m_title"  value="${meal.m_title}">
				</div>
				<div>
					...
					<input type="hidden" name="mImg" value="${meal.m_img}">
					<img id="preview" src="./${meal.m_img}"/>
				</div>	
				<div>
					<fieldset>
					<c:choose>
						<c:when test="${meal.m_star eq '★★★★★'}">
							<input type="radio" name="m_star" value="5" id="rate1" checked="checked">
						...
						<c:when test="${meal.m_star eq'★★★★☆'}">
							...
							<label for="rate1">★</label>
							<input type="radio" name="m_star" value="4" id="rate2" checked="checked">
							<label for="rate2">★</label>
							<input type="radio" name="m_star" value="3" id="rate3">
							<label for="rate3">★</label>
							<input type="radio" name="m_star" value="2" id="rate4">
						...
						<c:when test="${meal.m_star eq '★★★☆☆'}">
							...
							<input type="radio" name="m_star" value="4" id="rate2">
							<label for="rate2">★</label>
							<input type="radio" name="m_star" value="3" id="rate3" checked="checked">
							<label for="rate3">★</label>
							<input type="radio" name="m_star" value="2" id="rate4">
							<label for="rate4">★</label>
							<input type="radio" name="m_star" value="1" id="rate5">
						...
						<c:when test="${meal.m_star eq '★★☆☆☆'}">
							...
							<input type="radio" name="m_star" value="3" id="rate3">
							<label for="rate3">★</label>
							<input type="radio" name="m_star" value="2" id="rate4" checked="checked">
							<label for="rate4">★</label>
							<input type="radio" name="m_star" value="1" id="rate5">
							<label for="rate5">★</label>
						</c:when>
						<c:when test="${meal.m_star eq '★☆☆☆☆'}">
							...
							<input type="radio" name="m_star" value="2" id="rate4">
							<label for="rate4">★</label>
							<input type="radio" name="m_star" value="1" id="rate5" checked="checked">
							<label for="rate5">★</label>
						</c:when>
						<c:otherwise>
							<input type="radio" name="m_star" value="5" id="rate1">
				...
				<div>					
					<textarea cols="80" rows="10" name="m_text">${meal.m_text}</textarea>
				</div>
				<div id="btn">	
