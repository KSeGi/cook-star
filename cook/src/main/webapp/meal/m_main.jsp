	...
	<!-- page -->
		...
		<ul>
			...
			<c:if test="${currentPage ne 1}">
				...
				<li><a href="MealMain?currentPage=${currentPage+1-currentPage}">◁◁</a></li>
				<li><a href="MealMain?currentPage=${startPage-pageBlock}">◀</a></li>
				</c:if>
			</c:if>
			...
			<c:if test="${currentPage lt nPage}">
				...
				<li><a href="MealMain?currentPage=${startPage+pageBlock}">▶</a></li>
				<li><a href="MealMain?currentPage=${nPage}">▷▷</a></li>
				</c:if>
			</c:if>
		</ul>
		</div>
