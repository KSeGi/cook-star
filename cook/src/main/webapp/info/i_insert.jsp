...
<html>
    ...
    <!-- 측면 메뉴창 끝 -->
		...
		<form method = "post" enctype = "multipart/form-data" name = "frm" action="InfoInsert">
			<div>
				<input type="text" name="i_title" placeholder="제목을 입력해주세요.">
			</div>
			<div>
			...
			<div>					
				<textarea cols="80" rows="10" name="i_text" ></textarea>
			</div>
			<div id="btn">	
